...
```
## Multivariable moderator model figures

### Multivariable moderator model fixed-effect forest plot
...
#| echo: false
#| eval: true
#| fig-cap: "Fixed-effect estimates from the multivariable moderator model."

show_saved_figure("Figures/model_diagnostics/full_model_fixed_effects_forest_plot.png")
```

### Multivariable moderator model key predicted effects
...
# directional effects from the multivariable moderator model: marker type, migration,
...
#| echo: false
#| eval: true
#| fig-cap: "Predicted mixed-paternity prevalence for key fixed effects from the multivariable moderator model. Points or lines show posterior central predictions, and intervals or ribbons show 95% credible intervals."
